...
public class JPAPropertyRepositoryImpl implements PropertyRepository {
	...
	public List<ContactPerson> getAllContactPeople() {
		...
		for (int i = 0; i < propertyList.size(); i++) {
			ContactPerson temContactPerson = propertyList.get(i).getContactPerson();
			contactPersonSet.add(temContactPerson);
		}
		
		List<ContactPerson> contactPersonList = new ArrayList<ContactPerson>();
		for (ContactPerson contactPerson : contactPersonSet) {
